...
- Task 26 (`c3cc614`): enforcement-tiers doc, the agent hook walkthrough, sandboxed-agent reference architecture (incl. Appendix A: Knossos/OpenShell/NemoClaw mapping).
