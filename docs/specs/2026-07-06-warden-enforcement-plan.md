...
- [ ] **Step 2: Create `docs/enforcement-models.md` with exactly this content.**
  ...
  **What tier 0 does NOT protect against:**
  ...
  and blocks on the hook's verdict: Claude Code `PreToolUse` hooks, git
  ...
  [`claude-code-hook.md`](claude-code-hook.md) for a complete worked example.
...
- [ ] **Step 3: Create `docs/claude-code-hook.md` with exactly this content.**
...
- [ ] **Step 5: Run the content gate, then commit.**
  ...
  cd "/Users/kclear/Apps/Claude/Code/Software Development/iOS/holdmyagent-arbiter" && \
    ...
    grep -q "PreToolUse" docs/claude-code-hook.md && \
    grep -q "permissionDecision" docs/claude-code-hook.md && \
    grep -q "HMA_URL" docs/claude-code-hook.md && \
    ...
    ! grep -riE 'TBD|TODO' docs/enforcement-models.md docs/claude-code-hook.md docs/reference-sandboxed-agent.md && \
    echo DOCS-GATE-OK
  ```
...
- [ ] **Step 5: Run the gate green + full suites, commit.**
  ...
  cd "/Users/kclear/Apps/Claude/Code/Software Development/iOS/holdmyagent-arbiter" && \
    ...
    for d in docs/api.md docs/config.md docs/cli.md docs/warden.md docs/secret-managers.md \
             docs/enforcement-models.md docs/claude-code-hook.md docs/reference-sandboxed-agent.md; do \
